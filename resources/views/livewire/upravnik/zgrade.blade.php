                            ...
                            @if ($data->count())
                                @foreach ($data as $item) 
                                    ...
                                    <tr class="@if($item->sprat % 2 == 0) bg-emerald-50 @endif">
                                        ...
                                        <td>
                                            <button wire:click="$dispatch('openModal', { component: 'modals.tiket-prijava' })" class="my-1 bg-teal-500 hover:bg-teal-900 text-white font-bold py-1 px-2 rounded flex" title ="Promeni vlasnika">
