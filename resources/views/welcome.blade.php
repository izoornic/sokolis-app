  ...
  <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
    ...
    >
      ...
      <div class="tc wf ig pb no">
        ...
        @if (Route::has('login'))
            @auth
                <a href="{{ url('/dashboard') }}" class="ek pk xl">Početna</a>
            @else
                <a href="{{ route('login') }}" class="ek pk xl">Prijavi se</a>
            @endauth
        @endif
        <!-- 
         #### Izmenjen div <a href="{{ url('/dashboard') }}" :class="{ 'nk yl' : page === 'home', 'ok' : page === 'home' && stickyMenu }" class="ek pk xl">Početna</a>
